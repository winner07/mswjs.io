...
Unlike a Node.js `Request`, the request object in Mock Service Worker is a _partial_ request representation. This is due to the limitations on the nature of the data that can be transferred between a Service Worker and a client processes.
