...
Mock Service Worker supports [`debug`](https://github.com/visionmedia/debug) when run in Node.js. You can leverage this to look into the internals of how requests are intercepted, as well as provide the output logs to the library maintainers for more details.
